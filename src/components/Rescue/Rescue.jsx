...
<BodySection
    ...
    para={'At Sarama Rescue, we firmly believe a holistic approach to rescue is the most effective way even though rescuing at risk animals still remains our primary focus.'}
...
<div className="page-long-des-inner">
    <ul>
    <li><h6><a href="/adoptabledogs" >Check out our adorable adoptable dogs!</a></h6></li>
        <li><h6><a href="/adoptablecats" >Check out our adorable adoptable cats!</a></h6></li>
